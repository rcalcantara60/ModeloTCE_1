...
namespace Repository.MicroORM.Base
{
    public class MicroORMBaseRepository<TEntity> : IMicroORMBaseRepository<TEntity> where TEntity : class
    {
        ...
        public IEnumerable<TEntity> GetAll(string sql, ConnectionsName connectionsName)
        {
        ...
        public IEnumerable<T> GetAll<T>(string sql, ConnectionsName connectionsName) where T : class
        {
            DbConnectionContext = DbConnectionFactory.CreateDbConnection(connectionsName);
        ...
        public IEnumerable<TEntity> GetAllWithParam(string sql, ConnectionsName connectionsName, IEnumerable<dynamic> parameters)
        {
            DbConnectionContext = DbConnectionFactory.CreateDbConnection(connectionsName);
        ...
        public IEnumerable<T> GetAllWithParam<T>(string sql, ConnectionsName connectionsName, IEnumerable<dynamic> parameters) where T : class
        {
            DbConnectionContext = DbConnectionFactory.CreateDbConnection(connectionsName);
